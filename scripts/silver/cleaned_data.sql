...
SELECT 
    ...
    CASE 
        WHEN sls_order_dt IS NULL 
             OR TRY_CONVERT(DATE, CONVERT(VARCHAR(8), sls_order_dt)) IS NULL
        THEN NULL
    ...
    CASE 
        WHEN sls_ship_dt IS NULL 
             OR TRY_CONVERT(DATE, CONVERT(VARCHAR(8), sls_ship_dt)) IS NULL
        THEN NULL
    ...
    CASE 
        WHEN sls_due_dt IS NULL 
             OR TRY_CONVERT(DATE, CONVERT(VARCHAR(8), sls_due_dt)) IS NULL
        THEN NULL
